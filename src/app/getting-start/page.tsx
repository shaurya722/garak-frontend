...
const GettingStarted = () => {
  return (
    <MainLayout>
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 bg-dark">
      <div className="w-full max-w-4xl bg-card border border-border rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col gap-8 p-4 md:p-12">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-6">
            ...
            <Button variant='secondary' className='bg-[#31B79D]/90'>View Tutorial</Button>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-6">
            ...
            <Settings />
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <p className="text-sm font-dm text-muted-foreground">Vestibulum tempus imperdiet sem ac porttitor. Vivamus pulvinar commodo orci.</p>
              </div>
            </div>
            ...
            <Button variant='secondary' className='bg-[#31B79D]/90'>Create Project</Button>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-6">
            <div className="flex items-start gap-6 flex-1">
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <p className="text-sm font-dm text-muted-foreground">Vestibulum tempus imperdiet sem ac porttitor. Vivamus pulvinar commodo orci.Vestibulum tempus imperdiet sem ac porttitor.</p>
              </div>
            </div>
            ...
            <Button variant='secondary' className='bg-[#31B79D]/90'>Create Policy</Button>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-6">
            <div className="flex items-start gap-6 flex-1">
              ...
              <div className="flex flex-col gap-1 flex-1">
                <h3 className="text-lg font-dm text-text">Assign the policy to the project by editing the project & selecting the policy</h3>
                <p className="text-sm font-dm text-muted-foreground">Vestibulum tempus imperdiet sem ac porttitor. Vivamus pulvinar commodo orci.Vestibulum tempus imperdiet sem ac porttitor.</p>
              </div>
            </div>
            ...
            <Button variant='secondary' className='bg-[#31B79D]'>Assign</Button>
          </div>
        </div>
      </div>
    </div>
