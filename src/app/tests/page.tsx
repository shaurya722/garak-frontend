...
const availableProbes = [
    ...
    probes: [
      {
        ...
        description:
          'Runs all available probes - WARNING: This will take significant time to complete and may require substantial computational resources',
        isFullScan: true,
      },
    ],
  },
  {
    ...
    description:
      'Tests for harmful, toxic, or inappropriate content generation',
    probes: [
      {
        id: 'lmrc.Bullying',
  ...
  },
  {
    ...
    description:
      'Tests for jailbreak attempts and Do Anything Now (DAN) style attacks',
    probes: [
      {
...
function NewTestForm() {
  ...
  const handleInputChange = <K extends keyof TestForm>(
    field: K,
    value: TestForm[K]
  ) => {
    setFormData((prev) => ({
  ...
  const isFullScanSelected = () => {
    ...
    return (
      allProbeIds.length > 0 &&
      allProbeIds.every((id) => formData.probes.includes(id))
    )
  }
  ...
  const getRequiredApiKey = (): string | undefined => {
    switch (formData.model_type) {
      case 'rest':
        return formData.rest_api_key
      case 'openai':
        return formData.openai_api_key
      case 'huggingface':
        return 'not_required' // Basic huggingface doesn't need token
      case 'huggingface.InferenceAPI':
      case 'huggingface.InferenceEndpoint':
        return formData.hf_inference_token
      case 'replicate':
        return formData.replicate_api_token
      case 'cohere':
        return formData.cohere_api_key
      case 'groq':
        return formData.groq_api_key
      case 'nim':
        return formData.nim_api_key
      case 'ggml':
        return 'not_required' // GGML doesn't need API key
      default:
        return undefined
    }
  }
  ...
  const selectedConfig = configs.find(
    (c) => c.config_id === formData.rest_config_id
  )
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: ModelType) =>
                    handleInputChange('model_type', value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value='huggingface.InferenceAPI'>
                      Hugging Face Inference API
                    </SelectItem>
                    <SelectItem value='huggingface.InferenceEndpoint'>
                ...
                <>
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange('rest_config_id', value)
                      }
                    >
                      <SelectTrigger>
                    ...
                    {selectedConfig && (
                      <div className='mt-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                        ...
                        <p className='text-xs text-blue-600 dark:text-blue-300'>
                          {selectedConfig.rest_generator.method.toUpperCase()}{' '}
                          {selectedConfig.rest_generator.uri}
                        </p>
                      </div>
                    )}
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('rest_api_key', e.target.value)
                      }
                ...
                <>
                  ...
                  <div className='p-3 bg-green-50 dark:bg-green-900/20 rounded-lg'>
                    <p className='text-sm text-green-800 dark:text-green-200'>
                      <strong>Basic Hugging Face:</strong> No API token
                      required. A default token will be used automatically.
                    </p>
                  </div>
                </>
              )}

              {(formData.model_type === 'huggingface.InferenceAPI' ||
                formData.model_type === 'huggingface.InferenceEndpoint') && (
                <>
                  <div>
                    <Label htmlFor='model_name'>
                      {formData.model_type === 'huggingface.InferenceAPI'
                  ...
                  <div>
                    <Label htmlFor='hf_inference_token'>
                      Hugging Face Token *
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('hf_inference_token', e.target.value)
                      }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('replicate_api_token', e.target.value)
                      }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('cohere_api_key', e.target.value)
                      }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('groq_api_key', e.target.value)
                      }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('nim_api_key', e.target.value)
                      }
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('ggml_main_path', e.target.value)
                      }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select a security policy that defines which categories of tests
                to run
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange('policy_id', value || undefined)
                  }
                >
                  <SelectTrigger>
                ...
                {formData.policy_id && (
                  <div className='mt-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                    <p className='text-sm text-blue-800 dark:text-blue-200'>
                      <strong>Policy Selected:</strong>{' '}
                      {
                        policies.find((p) => p.policy_id === formData.policy_id)
                          ?.policy_name
                      }
                    </p>
                    <div className='mt-2'>
                      ...
                      <div className='flex flex-wrap gap-1'>
                        {policies
                          .find((p) => p.policy_id === formData.policy_id)
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange('generations', parseInt(e.target.value))
                    }
                  />
                  <p className='text-xs text-gray-600 mt-1'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='space-y-2 text-sm'>
                <p>
                  <strong>Model Type:</strong> {formData.model_type}
                </p>
                <p>
                  <strong>Model:</strong>{' '}
                  {formData.model_type === 'rest'
                ...
                {formData.policy_id ? (
                  ...
                  <p>
                    ...
                    <span className='text-red-600'>
                      Please select a policy above
                    </span>
                  </p>
                )}
                <p>
                  <strong>Generations:</strong> {formData.generations} per probe
                </p>
              </div>
            </CardContent>
          </Card>
